...
@Test
void expect() {
    String filePath = "src/test/java/com/auberer/compilerdesignlectureproject/reader/TestFile.txt";
    Reader reader = new Reader(filePath);
...
@Test
void isEOF() {
    String filePath = "src/test/java/com/auberer/compilerdesignlectureproject/reader/LeerFile.txt";
    Reader reader = new Reader(filePath);
