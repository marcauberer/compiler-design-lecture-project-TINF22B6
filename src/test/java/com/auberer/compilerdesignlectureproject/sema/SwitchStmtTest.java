...
public class SwitchStmtTest {
    ...
    @Test
    @DisplayName("Integration test should throw SemaError")
    void switchIntegrationTestException() {
        String code = "switch (true) { case 1: int i = 0; case 2: int i = 1; default: int i = 5; } ";
        Reader reader = new Reader(code);
        Lexer lexer = new Lexer(reader, false);
        Parser parser = new Parser(lexer);
