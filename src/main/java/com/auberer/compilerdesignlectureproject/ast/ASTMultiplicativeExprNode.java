...
public class ASTMultiplicativeExprNode extends ASTNode{
    ...
    public static Set<TokenType> getSelectionSet() {
        ...
        Set<TokenType> followSet = Set.of(TokenType.TOK_EOF, TokenType.TOK_LOGICAL_AND, TokenType.TOK_LOGICAL_OR, TokenType.TOK_EQUAL, TokenType.TOK_NOT_EQUAL, TokenType.TOK_PLUS, TokenType.TOK_MINUS); //TODO: follow Assignexpr fehöt
