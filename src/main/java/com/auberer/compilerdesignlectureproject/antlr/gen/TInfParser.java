...
public class TInfParser extends Parser {
	...
	public static final int
		...
		RULE_ifStmt = 5, RULE_afterIf = 6, RULE_else = 7, RULE_whileLoop = 8, 
		RULE_doWhileLoop = 9, RULE_forLoop = 10, RULE_switchStmt = 11, RULE_cases = 12, 
		RULE_default = 13, RULE_fctDef = 14, RULE_paramLst = 15, RULE_logic = 16, 
		RULE_fctCall = 17, RULE_callParams = 18, RULE_varDecl = 19, RULE_assignExpr = 20, 
		RULE_logicalExpr = 21, RULE_compareExpr = 22, RULE_additiveExpr = 23, 
		RULE_multiplicativeExpr = 24, RULE_prefixExpr = 25, RULE_atomicExpr = 26;
	private static String[] makeRuleNames() {
		return new String[] {
			"entry", "stmtLst", "stmt", "type", "printBuiltinCall", "ifStmt", "afterIf", 
			"else", "whileLoop", "doWhileLoop", "forLoop", "switchStmt", "cases", 
			"default", "fctDef", "paramLst", "logic", "fctCall", "callParams", "varDecl", 
			"assignExpr", "logicalExpr", "compareExpr", "additiveExpr", "multiplicativeExpr", 
			"prefixExpr", "atomicExpr"
		};
	}
	...
	public final StmtLstContext stmtLst() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			while ((((_la) & ~0x3f) == 0 && ((1L << _la) & 257749623742L) != 0)) {
				{
				setState(66);
				_errHandler.sync(this);
				switch (_input.LA(1)) {
	...
	public final DefaultContext default_() throws RecognitionException {
		...
		enterRule(_localctx, 26, RULE_default);
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(154);
	...
	public final LogicContext logic() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			if ((((_la) & ~0x3f) == 0 && ((1L << _la) & 257749614592L) != 0)) {
				{
				setState(182);
				assignExpr();
				}
	...
	public final CallParamsContext callParams() throws RecognitionException {
		...
		enterRule(_localctx, 36, RULE_callParams);
		try {
			setState(200);
			_errHandler.sync(this);
	...
	public final AtomicExprContext atomicExpr() throws RecognitionException {
		...
		enterRule(_localctx, 52, RULE_atomicExpr);
		try {
			setState(258);
			_errHandler.sync(this);
			switch (_input.LA(1)) {
